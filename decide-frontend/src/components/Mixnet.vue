      ...
      <li class="big-container" v-for="mixnet in mixnets" :key="mixnet.id">
        ...
        <div v-if="mixnet == selectedMixnet" :key="mixnet.id">
          ...
          <div v-if="mixnet.pubkey">
            ...
            <p><span class="bold">P:</span> {{ BigInt.fromBigInt(mixnet.pubkey.p) }}</p>
            <p><span class="bold">G:</span> {{ BigInt.fromBigInt(mixnet.pubkey.g) }}</p>
            <p><span class="bold">Y:</span> {{ BigInt.fromBigInt(mixnet.pubkey.y) }}</p>
        </div>
        <br>
        </div>
      </li>
