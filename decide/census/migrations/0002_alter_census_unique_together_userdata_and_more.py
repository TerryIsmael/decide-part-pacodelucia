    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('religion', models.CharField(choices=[('CH', 'Christianity'), ('IS', 'Islamism'), ('HI', 'Hinduism'), ('BU', 'Buddhism'), 
                                                       ('AG', 'Agnosticism'), ('AT', 'Atheism'), ('OT', 'Other')], max_length=2, null=True)),
                ('gender', models.CharField(choices=[('MA', 'Male'), ('FE', 'Female'), ('NB', 'Non binary'), ('NP', 'No response')], max_length=2, null=True)),
                ('civil_state', models.CharField(choices=[('SI', 'Single'), ('MA', 'Married'), 
                                                          ('DI', 'Divorced'), ('WI', 'Widower')], max_length=2, null=True)),
